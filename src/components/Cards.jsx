...
{
    return (
        <li className='relative grow bg-[#146EB4] p-5 rounded-lg flex flex-col space-y-4'>
            ...
            <main className='flex items-center pb-8'>
                <h1 className='grow text-white font-medium text-3xl'>₹2,312.23</h1>
            ...
            <aside className='absolute bottom-0 w-full left-0 px-6 py-2 rounded-lg flex justify-between bg-[#0E4F82]'>
                <h1 className='text-white text-sm'>Next payout date:</h1>
                <p className=' text-sm font-medium text-white'>Today, 04:00PM</p>
            </aside>
        </li>
    )
}
    ...
    return (
        <li className='rounded-lg grow flex flex-col space-y-4 p-5 bg-white' style={{boxShadow: "0px 2px 6px 0px rgba(26, 24, 30, 0.04)"}}>
            ...
            :(<main className='flex items-center'>
                <h1 className='text-dark text-3xl font-medium grow'>₹92,312.20</h1>
